create database curso_etec_exercicio;
go

use curso_etec_exercicio;
go
...
/* Select de curso e area*/
select * from area a
right join curso c ON a.id_are = c.id_are;

/*Select area , curso e professor , id_are, nm_are, nm_cur e nm_prof. */
...
/*Junção dados de area , curso , professor e materia */
